...
def calculate_rbp(id, p=0.9):
    ...
    ####### slct similar wrkrs
    wrkr_no_in_each_tg = 50 / len(tags)
    wrkr_no_in_each_tg = math.ceil(wrkr_no_in_each_tg)
    ...
    our_sim_wrkrs = our_wrkrs['userId'].values.tolist()[:50]
...
if __name__ == '__main__':
    ...
    shrf_df.to_csv(r"./sharif_top_1.csv", index = False, header=True)
    ...
    chna_df.to_csv(r"./china_top_1.csv", index = False, header=True)
    ...
    our_df.to_csv(r"./our_top_1.csv", index = False, header=True)